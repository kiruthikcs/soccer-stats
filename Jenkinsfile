...
stage('Deploy') {
    node {
       ...
       // http://34.221.40.216:8081/repository/demoapp-rele/br/com/meetup/ansible/soccer-stats/0.0.2-3/soccer-stats-0.0.2-3.war                           
        ...
        sh "ansible-playbook playbook.yml --extra-vars " APP_NAME=soccer-stats ARTIFACT_URL=http://54.70.187.156:8081/repository/demoapp-rele/br/com/meetup/ansible/soccer-stats/0.0.2-37/soccer-stats-0.0.2-37.war"
